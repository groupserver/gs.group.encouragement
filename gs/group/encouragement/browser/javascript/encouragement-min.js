jQuery.noConflict();function GSGroupEncouragement(){function e(k,n,j,o){var m=null,l=null,i=null,h=null;
...
e(i,j,k,"left")}function f(h){return jQuery(h).length>0}function a(){if(f("#gs-group-encouragement-topics")){window.setTimeout(g,2000)
